        ...
        <div className="absolute top-[85px] right-0 w-[48%] h-[calc(100%-85px)] z-30 flex flex-col items-end pr-5 text-right font-sans">
            ...
            <div className="relative w-full flex flex-col items-end mt-8">
                ...
                <div className="relative z-10 flex flex-col items-end">
                    ...
                    {/* Number Display - Adjusted line height and removed negative margins */}
                    <div className="flex items-baseline justify-end gap-1">
                        <span className="text-[7.5rem] font-teko font-black text-white leading-[0.8] tracking-tighter drop-shadow-[0_0_30px_rgba(59,130,246,0.6)] py-1">
                            {winner.statValue}
                        </span>
                        <span className="text-3xl font-black text-white italic transform -skew-x-12">
                            {statUnit}
                        </span>
                    </div>
                </div>
